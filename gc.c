...
static inline VALUE
newobj_of(void *newobj_cache, VALUE klass, VALUE flags, shape_id_t shape_id, bool wb_protected, size_t size)
{
    VALUE obj = rb_gc_impl_new_obj(rb_gc_get_objspace(), newobj_cache, klass, flags, wb_protected, size);
...
rb_wb_unprotected_newobj_of(VALUE klass, VALUE flags, shape_id_t shape_id, size_t size)
{
    ...
    return newobj_of(GET_EC()->newobj_cache, klass, flags, shape_id, FALSE, size);
}
...
rb_data_object_wrap(VALUE klass, void *datap, RUBY_DATA_FUNC dmark, RUBY_DATA_FUNC dfree)
{
    ...
    VALUE obj = newobj_of(GET_EC()->newobj_cache, klass, T_DATA, ROOT_SHAPE_ID, !dmark, sizeof(struct RTypedData));
...
typed_data_alloc(VALUE klass, VALUE typed_flag, void *datap, const rb_data_type_t *type, size_t size)
{
    ...
    VALUE obj = newobj_of(GET_EC()->newobj_cache, klass, T_DATA | RUBY_TYPED_FL_IS_TYPED_DATA, ROOT_SHAPE_ID, wb_protected, size);
